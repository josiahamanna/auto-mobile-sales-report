 ...
 * VehiclesController
 *
 * @description :: Actions for total number of vehicles within constraints
 */
...
module.exports = {
  totalCars: async (req, res) => {
    try {
      ...
      res.serverError({ status: 500, msg: "Please check query parameter" });
    }
  },
  ...
  aboveAverageSaleValue: async (req, res) => {
    ...
    if (aboveAverageSaleValueVehiclesList.length) {
      res.ok({
        status: 200,
        data
      });
